...
class JSend
{
    public static function success($message, $data = array(), $response_code = 200)
    {
        return JSend::situation('success', $message, $data, $response_code);
    }

    public static function fail($message, $data = array(), $response_code = 404)
    {
        return JSend::situation('fail', $message, $data, $response_code);
    }

    public static function error($message, $data = array(), $response_code = 500)
    {
