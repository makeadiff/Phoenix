...
class BasicAuth
{
    public function handle($request, Closure $next)
    {
        ...
        if(!in_array(DEVELOPER_GROUP_ID, $group_ids)) {
            $headers = array('WWW-Authenticate' => 'Basic');
            return response('{"status": "fail", "data": ["Your auth account does not have the Developer user group. Contact the tech team of MAD to add this to your account."]}', 401, $headers);
        } 
