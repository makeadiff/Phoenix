...
class EventTest extends TestCase
{
    ...
    public function testEventCredit()
    {
        ...
        $para_credit_lost_by_missing_ac_circle_without_informing = 18;
        ...
        $this->assertEquals($credit_data[0]->change, -2);
    ...
    public function testEventEdit()
    {
        ...
        $para_credit_lost_by_missing_ac_circle_after_informing = 17;
        $credit_model = new Credit;
        $credit_data = $credit_model->search([
                'user_id' => $this->user_id, 
